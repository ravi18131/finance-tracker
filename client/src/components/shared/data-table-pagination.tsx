...
export function DataTablePagination<TData>({
  ...
  return (
    <div className="flex items-center justify-between px-2 pt-3 my-3 border-t">
      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        <div className="w-[100px] items-center justify-center text-sm font-medium hidden md:flex">
